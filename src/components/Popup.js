...
const Popup = () => {
    ...
    return (_jsxs("div", { className: "p-6 max-w-sm mx-auto bg-gray-800 text-white rounded-lg shadow-md space-y-4", children: [_jsx("input", { type: "text", placeholder: "Enter link", value: link, onChange: (e) => setLink(e.target.value), className: "w-full p-2 bg-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500" }), _jsx("textarea", { placeholder: "Enter note", value: note, onChange: (e) => setNote(e.target.value), className: "w-full p-2 bg-gray-700 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-blue-500 break-words whitespace-pre-wrap" }), _jsxs("div", { className: "flex space-x-2", children: [_jsx("button", { onClick: handleSave, className: "flex-1 p-2 bg-[#a07ee7] hover:bg-purple-600 rounded-md transition duration-150 ease-in-out", children: "Save Note" }), _jsx("button", { onClick: handleGetCurrentTabLink, className: "flex-1 p-2 bg-purple-600 hover:bg-purple-700 rounded-md transition duration-150 ease-in-out", children: "GetAuto" })] }), _jsx("div", { className: "space-y-2 scrollable max-h-64", children: savedNotes.map((item, index) => (_jsxs("div", { className: "p-3 bg-gray-700 rounded-md relative hover:bg-gray-600 transition duration-150 ease-in-out", children: [_jsx("button", { onClick: () => handleDeleteNote(index), className: "absolute top-1 right-1 w-6 h-6 flex items-center justify-center bg-transparent rounded-full hover:bg-gray-600 focus:outline-none", "aria-label": "Delete note", children: _jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "currentColor", className: "w-4 h-4 text-red-300 hover:text-red-400", viewBox: "0 0 24 24", children: _jsx("path", { d: "M6 19c0 1.104.896 2 2 2h8c1.104 0 2-.896 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z" }) }) }), _jsxs("div", { children: [_jsx("a", { href: item.link, target: "_blank", rel: "noopener noreferrer", className: "text-blue-400 hover:text-blue-300 break-words whitespace-pre-wrap", children: item.link }), _jsx("p", { className: "text-gray-300 break-words whitespace-pre-wrap", children: item.note })] })] }, index))) }), _jsxs("div", { className: "flex space-x-2 pt-4 border-t border-gray-600", children: [_jsx("button", { onClick: downloadFile, className: "flex-1 p-2 bg-[#a07ee7] hover:bg-purple-500 rounded-md transition duration-150 ease-in-out text-white", children: "Download Notes" }), _jsx("button", { onClick: handleClearAll, className: "flex-1 p-2 bg-red-600 hover:bg-red-700 rounded-md transition duration-150 ease-in-out", children: "Clear All" })] })] }));
};
